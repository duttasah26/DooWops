...
export default function GamePage({
  ...
  // 🔧 FIXED: Update prevTrackUri whenever displayTrack changes, regardless of play state
  useEffect(() => {
  ...
  // 🔧 FIXED: Only play track when conditions are met AND choiceIndex changes (user navigates)
  useEffect(() => {
    if (
      !choicesLoading &&
      deviceId &&
  ...
  return (
    <div className="min-h-screen w-screen relative bg-gradient-to-br from-purple-900 to-black text-white overflow-x-hidden flex flex-col items-center">
      ...
      <div className="relative w-full flex flex-row items-start justify-center mb-6 max-w-6xl">
        {/* 🔧 FIXED: Turn text positioning based on active player */}
        {activePlayer === 1 && (
          <div
